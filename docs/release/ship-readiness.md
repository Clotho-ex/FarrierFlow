...
| TestFlight install and complete physical-iPhone workflow | NOT YET VERIFIED | On 2026-09-07, the owner reported installing build 1.0 (2) on an iPhone 14 Pro running iOS 26.6.1. The immediate live portal recheck still showed `Invited` with no session. Confirm a clean first launch, then exercise onboarding through next appointment, PDF/share, photos, background/foreground, relaunch, Light/Dark, keyboard, touch targets, and outdoor legibility before this combined gate can pass. |
