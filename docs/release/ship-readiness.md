...
| TestFlight install and complete physical-iPhone workflow | NOT YET VERIFIED | The Account Holder is invited to the internal group and exact build 2 is ready, but there is no install evidence. Accept/open the TestFlight invitation, install build 2 on physical iPhone `00008120-0016043C0138C01E`, record tester/date/device/OS, and exercise onboarding through next appointment, PDF/share, photos, background/foreground, relaunch, Light/Dark, keyboard, touch targets, and outdoor legibility. |
