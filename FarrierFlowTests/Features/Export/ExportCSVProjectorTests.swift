...
struct ExportCSVProjectorTests {
    ...
    @Test func projectsEveryVersionOneTableWithExactWidthsAndOptionalEmpties() throws {
        ...
        #expect(tables[6].rows[0][0] == .raw("visit-000001"))
        ...
        #expect(tables[11].rows[0][7] == .raw("paid"))
        ...
        #expect(tables[13].rows[0] == [.raw("invoice-line-item-000001"), .userText("Milo"), .userText("Trim"), .raw("12500"), .raw("USD"), .raw("$125.00"), .raw("invoice-visit-000001"), .raw("work-item-000001")])
    ...
    private static func snapshot(outcome: String = "serviced", status: String = "paid", currencyCode: String = "USD", minorUnits: Int64 = 12_500) -> ExportSnapshot {
        ...
        return .init(
            context: context,
            businessProfiles: [.init(id: businessProfile, name: "Farrier = Co", phone: "555-0100", email: nil, address: nil, defaultInvoiceNote: nil, defaultAppointmentDurationMinutes: 45, defaultInvoiceDueDays: nil, nextInvoiceNumber: 7)],
